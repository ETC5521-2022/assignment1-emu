...
It can be seen from Graph.6a and 6b that the trend of overexploited stock and world seafood consumption have a similar pattern. For each individual trend between two lines in Graph.6a, we can find out a similar trend between two lines with the corresponded color in Graph.6b.
